...
document.getElementById("closeImageViewer").onclick=closeImageViewer;document.getElementById("imageViewer").onclick=e=>{if(e.target.id==="imageViewer")closeImageViewer()};document.addEventListener("keydown",e=>{if(e.key==="Escape")closeImageViewer()});