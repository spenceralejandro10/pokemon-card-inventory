...
check("Defensas críticas de Mercado Libre activas",function(){
 ...
 assert(oauth.includes('manualChecks.value_flow === true'),"OAuth debe exigir un flujo productivo que genere valor");
 ...
 assert(adminHtml.includes('data-ml-manual="value_flow"'),"El panel debe impedir conexiones destinadas solo a lectura");
